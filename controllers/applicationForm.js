...
const applicationForms = async (req, res) => {
  ...
  try {
    // Create the application form data
    const formData = await ApplicationForm.create({
      firstName,
      lastName,
      email,
    ...
    const generatePdfBuffer = async (data) => {
      return new Promise((resolve, reject) => {
        ...
        doc
          ...
          .font("Helvetica")
          .text(data.permanentAddress);

        doc
          .font("Helvetica-Bold")
          .text("Temporary Address: ", { continued: true })
          .font("Helvetica")
          .text(data.temporaryAddress);

        doc
          .font("Helvetica-Bold")
          .text("Father Name: ", { continued: true })
          .font("Helvetica")
          .text(data.fatherName);

        doc
          .font("Helvetica-Bold")
          .text("Father Occupation: ", { continued: true })
          .font("Helvetica")
          .text(data.fatherOccupation);

        doc
          .font("Helvetica-Bold")
          .text("Father's Income: ", { continued: true })
          .font("Helvetica")
          .text(data.fatherIncome);
        ...
        doc
          .font("Helvetica-Bold")
          .text("Bank Acc. Number: ", { continued: true })
          .font("Helvetica")
          .text(data.bankAccountNumber);

        doc
          .font("Helvetica-Bold")
          .text("Swift Code: ", { continued: true })
          .font("Helvetica")
          .text(data.swiftCode);
        ...
        doc
          .font("Helvetica-Bold")
          .text(
            "Have you applied for a loan from any other organization such as your medical college, alumni, or any physician working in the USA or Pakistan? ",
            {
              continued: true,
            }
          )
          .font("Helvetica")
          .text(data.appliedToOtherOrganization);

        doc
          .font("Helvetica-Bold")
          .text(
            "Nationality/Permanent Residency/Work Permit of any country other than Pakistan: ",
            { continued: true }
          )
          .font("Helvetica")
          .text(data.nationalityOtherThanPakistan);

        doc
          .font("Helvetica-Bold")
          .text(
            "Have you travelled internationally for personal or professional reasons to attend conferences or to do electives?: ",
            { continued: true }
          )
          .font("Helvetica")
          .text(data.travelledInternationally);

        if (data.travelledInternationally === "Yes") {
          doc
            .font("Helvetica-Bold")
            .text('If "Yes", Please Provide details: ', { continued: true })
            .font("Helvetica")
            .text(data.travelledInternationallyDetails);
        }

        doc
          .font("Helvetica-Bold")
          .text("Why you should be considered: ", { continued: true })
          .font("Helvetica")
          .text(data.whyWeConsidered);
        ...
        doc
          ...
          .fillColor("black")
          .font("Helvetica-Bold")
          .text("Medical College Name: ", { continued: true })
          .font("Helvetica")
          .text(data.collegeName);

        doc
          .font("Helvetica-Bold")
          .text("Graduation Year: ", { continued: true })
          .font("Helvetica")
          .text(data.graduationYear);

        doc
          .font("Helvetica-Bold")
          .text("1st Professional MBBS Grade: ", { continued: true })
          .font("Helvetica")
          .text(data.firstYearGrade);

        doc
          .font("Helvetica-Bold")
          .text("2nd Professional MBBS Grade: ", { continued: true })
          .font("Helvetica")
          .text(data.secondYearGrade);

        doc
          .font("Helvetica-Bold")
          .text("3rd Professional MBBS Grade: ", { continued: true })
          .font("Helvetica")
          .text(data.thirdYearGrade);

        doc
          .font("Helvetica-Bold")
          .text("Final Professional MBBS Grade: ", { continued: true })
          .font("Helvetica")
          .text(data.finalYearGrade);

        doc
          .font("Helvetica-Bold")
          .text("Other Qualifications: ", { continued: true })
          .font("Helvetica")
          .text(data.otherQualifications);

        doc
          .font("Helvetica-Bold")
          .text("Awards & Honors: ", { continued: true })
          .font("Helvetica")
          .text(data.awardsHonors);
        ...
        doc
          ...
          .fillColor("black")
          .font("Helvetica-Bold")
          .text("Step 1: ", { continued: true })
          .font("Helvetica")
          .text(`Score: ${data.step1Score} || Attempt: ${data.step1Attempt}`);

        doc
          .font("Helvetica-Bold")
          .text("Step 2 CK: ", { continued: true })
          .font("Helvetica")
          .text(
            `Score: ${data.step2CKScore} || Attempt: ${data.step2CKAttempt}`
          );
        ...
        doc
          .font("Helvetica-Bold")
          .text("Step 3: ", { continued: true })
          .font("Helvetica")
          .text(`Score: ${data.step3Score} || Attempt: ${data.step3Attempt}`);
