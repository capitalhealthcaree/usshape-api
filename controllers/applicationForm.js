...
const applicationForms = async (req, res) => {
  ...
  try {
    ...
    const pdfBuffer = await generatePdfBuffer({ firstName, lastName, email, phoneNumber });
    ...
    const mailOptionsAdmin = {
      ...
      html: `
        ...
        <p><b>Father's Occupation:</b> ${fatherOccupation}</p>
        <p><b>Father's Income:</b> ${fatherIncome}</p>
...
module.exports = applicationForms;
